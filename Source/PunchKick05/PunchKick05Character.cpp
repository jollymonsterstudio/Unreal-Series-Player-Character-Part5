...
APunchKick05Character::APunchKick05Character()
{
...
void APunchKick05Character::BeginPlay()
{
	Super::BeginPlay();
...
void APunchKick05Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &APunchKick05Character::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &APunchKick05Character::MoveRight);

	// We have 2 versions of the rotation bindings to handle different kinds of devices differently
	// "turn" handles devices that provide an absolute delta, such as a mouse.
	// "turnrate" is for devices that we choose to treat as a rate of change, such as an analog joystick
	PlayerInputComponent->BindAxis("Turn", this, &APawn::AddControllerYawInput);
	PlayerInputComponent->BindAxis("TurnRate", this, &APunchKick05Character::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &APunchKick05Character::LookUpAtRate);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &APunchKick05Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &APunchKick05Character::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &APunchKick05Character::OnResetVR);

	// attack functionality
	PlayerInputComponent->BindAction("Attack", IE_Pressed, this, &APunchKick05Character::AttackInput);
	PlayerInputComponent->BindAction("Attack", IE_Released, this, &APunchKick05Character::AttackEnd);
}

void APunchKick05Character::OnResetVR()
{
...
void APunchKick05Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void APunchKick05Character::MoveForward(float Value)
{
...
void APunchKick05Character::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
...
void APunchKick05Character::AttackInput()
{
...
void APunchKick05Character::AttackStart()
{
	Log(ELogLevel::INFO, __FUNCTION__);
...
void APunchKick05Character::AttackEnd()
{
	Log(ELogLevel::INFO, __FUNCTION__);
...
void APunchKick05Character::OnAttackHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
...
void APunchKick05Character::Log(ELogLevel LogLevel, FString Message, ELogOutput LogOutput)
{
